...
public class CadastrarCargo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(tipo == 2){
                request.getRequestDispatcher("administrador/cadastrarcargo.jsp").forward(request, response);
            }else if(tipo == 1){
                request.getRequestDispatcher("profissional/cadastrarcargo.jsp").forward(request, response);
            }
