...
public class CarregarAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("administrador/alteraradministrador.jsp").forward(request, response);
        }catch (Exception ex){
            System.out.println("Problemas no Servlet ao carregar os dados da modalidade: Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
