...
public class DadosEntrega extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            GenericDAO daopedido = new PedidoDAOImpl();
            request.setAttribute("profissionais", dao.listar());
            request.setAttribute("pedidos", daopedido.listar());
           
                request.getRequestDispatcher("profissional/cadastrarentrega.jsp").forward(request, response);
            
            
        } catch (Exception e) {
            System.out.println("Problemas ao carregar dados entrega"+e.getMessage());
            e.printStackTrace();
        }
