<%-- 
    ...
    Created on : 30/05/2014, 20:04:07
    Author     : Aluno
--%>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="menu3">
                ...
                <a href="<%= request.getContextPath()%>/ListarPedido" class="current">Listar Pedido</a>
                ...
                <table align="center" border="0" class="table table-striped table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%= pedido.getStatusPedido()%></td>
                            <td><%= pedido.getHorarioChegadaPedido()%></td>
                            <td><%= pedido.getReferenciaPedido()%></td>
                            <td><%= pedido.getRuaPedido()%></td>
                            <td><%= pedido.getBairroPedido()%></td>
                            <td><%= pedido.getNumeroPedido()%></td>
                            <td><%= pedido.getDescricaoPedido()%></td>
                            <td><%= pedido.getContatoCliente()%></td>
                            <td><a href="ExcluirPedido?idPedido=<%=pedido.getIdPedido()%>">Excluir</a></td>
                            <td><a href="CarregarPedido?idPedido=<%=pedido.getIdPedido()%>">Alterar</a></td>
