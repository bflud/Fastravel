    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="menu3">
                ...
                <a href="<%= request.getContextPath()%>/administrador/cadastrarcargo.jsp" class="current">Cadastrar Cargo</a>
                <a href="<%= request.getContextPath()%>/ListarCargo?tipo=<%= 2 %>">Listar Cargo</a>
            </div>
            <div class="menu3sub">
                <div id="cadastroemp">
                    <form action="<%= request.getContextPath()%>/CadastrarCargo?tipo=<%= 2%>" method="POST" class="form-group">
                        <center>
