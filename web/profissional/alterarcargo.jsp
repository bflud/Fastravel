            ...
            <div class="container-fluid">
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        ...
                        <li ><a href="<%= request.getContextPath()%>/LogarProfissional?acao=logout">Administrador</a></li>
                        <li class="active"><a href="<%= request.getContextPath()%>/iniciogerente.jsp">Profissional</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="menu3subalterar">
                ...
                <form action="<%= request.getContextPath()%>/AlterarCargo?tipo=<%= 1 %>" method="POST">
