            ...
            <div class="container-fluid">
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        ...
                        <li ><a href="LogarProfissional?acao=logout">Administrador</a></li>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="menu3">
                ...
                <a href="<%= request.getContextPath()%>/ListarCargo?tipo=<%= 1 %>" class="current">Listar Cargo</a>
                ...
                <table align="center" border="0" class="table table-striped table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="ExcluirCargoProf?idCargo=<%=cargo.getIdCargo()%>">Excluir</a></td>
                            <td><a href="CarregarCargoProf?idCargo=<%=cargo.getIdCargo()%>">Alterar</a></td>
