...
<body>
            ...
            <div class="container-fluid">
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="CarregarLoginSenha?idProfissional=<%= session.getAttribute("idProfissional") %>" ><%= session.getAttribute("nomePessoa") %></a></li>
                        <li class="divider"></li>
                        <li>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="menu3">
                <a href="<%= request.getContextPath()%>/DadosProfissional?tipo=<%= 1%>" class="current">Cadastrar Profissional</a>
            ...
            <div class="menu3sub maior">
                <div ><center><h4>${mensagem}</h4><br>
                    <form action="<%= request.getContextPath()%>/CadastrarProfissional?tipo=<%= 1 %>" method="POST" class="form-group">
                        ...
                        <table >
                            ...
                            <tr>			
                                <td>
                                    <label>Emp. <select name="idEmpresa">
                                        <%
                            ...
                            <tr>			
                                <td>
                                    <label>Cargo <select name="idCargo">
                                        <%
