<%-- 
    Document   : localizacaoentrega2
    Created on : 03/06/2014, 15:57:09
    Author     : Andrey
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        ...
                        <li class=""><a href="loginprofissional.jsp">Profissional</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </div>
            ...
            <section id="wrapper">
                ...
                <script>
                    function success(position) {
                        ...
                        //alert ('chamou');
                        var latlng = new google.maps.LatLng(-20.280127361999224, -50.24401146484929);
                        //alert(latlng);
